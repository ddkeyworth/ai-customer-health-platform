  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-xs text-zinc-400 mb-8">
        ...
        saved. Not yet read by any live feature - today, Health scores and narratives are only ever generated by
        batch scripts run manually against the platform&apos;s own key, never triggered by a workspace&apos;s own
        activity. This field exists because the point of a downloadable, open-source project is that anyone running
        their own instance should use their own Anthropic key, not the demo deployment&apos;s - once live,
        per-account agentic playbooks are built (see README.md), they will read this workspace&apos;s own key
